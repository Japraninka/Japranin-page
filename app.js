/* =========================================================
   Japranin – Seitenskript
   1. Mobiles Menü
   2. Jahreszahl im Footer
   3. Galerie-Lightbox
   Alles ist gegen fehlende Elemente abgesichert, damit das
   Skript auf jeder Seite ohne Fehler läuft.
   ========================================================= */
...
(function () {
  ...
  if (toggle && menu) {
    ...
    // Nach einem Klick auf einen Link das Menü schließen.
